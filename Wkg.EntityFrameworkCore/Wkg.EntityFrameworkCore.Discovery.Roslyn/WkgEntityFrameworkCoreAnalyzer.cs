...
/// </summary>
internal sealed class WkgEntityFrameworkCoreAnalyzer : DeploymentVersionInfo
{
    ...
    private WkgEntityFrameworkCoreAnalyzer() : base
    (
    ...
    /// Provides version information for the Wkg.EntityFrameworkCore framework.
    /// </summary>
    public static WkgEntityFrameworkCoreAnalyzer VersionInfo { get; } = new WkgEntityFrameworkCoreAnalyzer();
}
...
/// </para>
/// </param>
internal abstract class DeploymentVersionInfo(string versionPrefix, string versionSuffix, string dateTimeUtc)
{
    /// <summary>
