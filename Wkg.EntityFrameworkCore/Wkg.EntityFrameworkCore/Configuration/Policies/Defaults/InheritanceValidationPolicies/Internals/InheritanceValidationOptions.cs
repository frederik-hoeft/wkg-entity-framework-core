...
internal sealed record InheritanceValidationOptions(Type RequiredBaseType, FrozenSet<Type> ExceptedTypes, ImmutableArray<Type> ExceptedBaseTypes, ValidationFailureDelegate ValidationFailureDelegate)
{
